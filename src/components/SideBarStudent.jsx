              ...
              <div className="offcanvas-body p-3 p-xl-0">
                <div className="bg-blue border rounded-3 pb-0 p-3 w-100">
                  ...
                  <div className="list-group list-group-dark list-group-borderless">
                    ...
                    >
                      <i className="bi bi-camera-video-fill fa-fw me-2" />
                    ...
                    <Link
                      ...
                      <Link
                      className={`list-group-item ${activeNavItem === "/GradeStudent" ? "active" : ""
                        }`}
                      to="/GradeStudent"
                      onClick={() => handleNavItemClick("/GradeStudent")}
                    >
                    <FontAwesomeIcon icon={faCalendarAlt} className="fa-fw me-1" />{" "}
                      GradeStudent
                    </Link>
                    ...
                    <Link
                      className={`list-group-item ${activeNavItem === "/time-slots-student" ? "active" : ""
                        }`}
                    ...
                    <Link
                      className={`list-group-item ${activeNavItem === "/profile-student" ? "active" : ""
                        }`}
                      to="/profile-student"
