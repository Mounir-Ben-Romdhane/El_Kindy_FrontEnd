...
import useAxiosPrivate from 'hooks/useAxiosPrivate';
 ...
 const  Index = () => {
  ...
  const getAvatarSrc = () => {
    ...
    } else if (user && user.picturePath === "" && user.gender !== "") {
    ...
    return (
      <section className="pt-0">
        ...
        <div className="container-fluid px-0">
          <div className="bg-blue h-100px h-md-200px rounded-0" style={{background: 'url(assets/images/pattern/05.png) no-repeat center center', backgroundSize: 'cover'}} />
        </div>
