                ...
                >
                  ...
                  <ul className="avatar-group mb-0">
                    ...
                    <li className="avatar avatar-sm">
                      <img
                        className="avatar-img rounded-circle border-white"
                        src="/assets/images/element/03.jpg"
                        alt="avatar"
                      />
                    </li>
                    <li className="avatar avatar-sm">
                      <img
                        className="avatar-img rounded-circle border-white"
                        src="/assets/images/element/04.jpg"
                        alt="avatar"
                      />
                    </li>
                    <li className="avatar avatar-sm">
                          ...
                          <div className="col-sm-4 col-lg-6 col-xl-4">
                            <div className="d-flex align-items-center">
                              ...
                              <div>
                                ...
                                <h5 className="mb-0">134 DT</h5>
                              </div>
                            </div>
                          </div>
                          <div className="col-sm-4 col-lg-6 col-xl-4 d-flex justify-content-end">
                            <div className="d-flex align-items-center">
                              <a
                                href="#"
                                className="btn btn-orange rounded-2 me-3 mb-0"
