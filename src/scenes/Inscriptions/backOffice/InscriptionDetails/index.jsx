      ...
      <div className="card bg-transparent border rounded-3 h-100">
        ...
        <div className="card-body">
          ...
          <div className="avatar avatar-xl mb-3">
            <img className="avatar-img rounded-circle border border-white border-3 shadow" src="/assets/images/element/01.jpg" alt />
          </div>
          {/* Information START */}
          <div className="row">
            {/* Information item */}
            <div className="col-md-6">
              <ul className="list-group list-group-borderless">
                <li className="list-group-item">
                  <span>Full Name:</span>
                  <span className="h6 mb-0">{inscription.firstName} {inscription.lastName}</span>
                </li>
                <li className="list-group-item">
                  <span>Email ID:</span>
                ...
                <li className="list-group-item">
                  <span>Gender</span>
                  <span className="h6 mb-0">{inscription.gender}</span>
                </li>
                <li className="list-group-item">
                  <span>Date of birth: </span>
                  <span className="h6 mb-0">{inscription.dateOfBirth}</span>
                </li>
                <li className="list-group-item">
                  <span>Location:</span>
            ...
            <div className="col-md-6">
              <ul className="list-group list-group-borderless">
                <li className="list-group-item">
                  ...
                  <span className="h6 mb-0">{inscription.parentName}</span>
                </li>
                <li className="list-group-item">
                  <span>Parent profession:</span>
                  <span className="h6 mb-0">{inscription.parentProfession}</span>
                </li>
                <li className="list-group-item">
                  <span>Mobile Number N°1:</span>
                  <span className="h6 mb-0">+256 {inscription.phoneNumber1}</span>
                </li>
                <li className="list-group-item">
                  <span>Mobile Number N°2:</span>
                  <span className="h6 mb-0">+256 {inscription.phoneNumber2}</span>
                </li>
              </ul>
            </div>
            {/* Information item */}
            <div className="col-12">
              <ul className="list-group list-group-borderless">
                <li className="list-group-item">
                  <span>Education:</span>
                  <span className="h6 mb-0">{inscription.niveauEtude}</span>
                </li>
              </ul>
            </div>
            {/* Information item */}
      ...
      <div className="row g-4">
        ...
        <div className="col-md-6 col-xxl-12">
          <div className="card bg-transparent border overflow-hidden">
            {/* Card header */}
            <div className="card-header bg-light border-bottom">
              <h5 className="card-header-title mb-0">Liked courses</h5>
            </div>
            {/* Card body */}
        ...
        <div className="col-md-6 col-xxl-12">
          <div className="card bg-transparent border overflow-hidden">
            {/* Card header */}
            <div className="card-header bg-light border-bottom">
              <h5 className="card-header-title mb-0">Available time</h5>
            </div>
            {/* Card body */}
            <div className="card-body p-0">
              <div className="d-sm-flex justify-content-between p-4">
