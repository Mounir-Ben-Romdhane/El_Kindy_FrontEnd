...
<section className="position-relative pt-5">
  ...
  <div className="container">
    <div className="row align-items-center">
      ...
      <div className="col-lg-6 position-relative z-index-9">
        <h6 className="mb-3 font-base"><i className="bi bi-book me-2" /> {course.courseCategory?.name}</h6>
        <h2 className="display-4">{course.title}</h2>
  ...
  <div className="container">
  <div className="row">
    <div className="col-md-10 d-flex justify-content-center mt-6">
      <div dangerouslySetInnerHTML={{ __html: course?.fullDescription }}></div>
    </div>
  </div>
</div>
