...
function Index() {
    ...
    const handleLike = async (like) => {
        try {
            ...
            await axios.put(`https://el-kindy-project-backend.onrender.com/shops/${id}`, { likedShop: like ? 1 : 0 }); // Remplacez "your-api-url" par l'URL de votre API
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`https://el-kindy-project-backend.onrender.com/shops/${id}`); // Remplacez "your-api-url" par l'URL de votre API
                                        ...
                                        <div className="col-md-8 col-xl-12">
                                            <div className="card shadow">
                                                <div className="rounded-3">
                                                    <img src={`https://el-kindy-project-backend.onrender.com/assets/${shop.picturePath}`} className="card-img-top" alt="book image" />
                                                </div>
